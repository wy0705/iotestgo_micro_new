...
func (e *Example2) Call(ctx context.Context, req *proto.CallRequest, rsp *proto.CallResponse) error {
...
func (f *Foo2) Bar(ctx context.Context, req *proto.EmptyRequest, rsp *proto.EmptyResponse) error {
...
func III3() {
	...
	// 注册Example接口处理器
	proto.RegisterExampleHandler(service.Server(), new(Example2), api.WithEndpoint(&api.Endpoint{
	...
	// 注册Foo接口处理器
	proto.RegisterFooHandler(service.Server(), new(Foo2), api.WithEndpoint(&api.Endpoint{
		Name:    "Foo.Bar",
		Path:    []string{"/foo/bar"},
